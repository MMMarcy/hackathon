@REM hackhathon launcher script
@REM
@REM Envioronment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM HACKHATHON_config.txt found in the HACKHATHON_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%HACKHATHON_HOME%"=="" set "HACKHATHON_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%HACKHATHON_HOME%\lib\"
...
set "CFG_FILE=%HACKHATHON_HOME%\HACKHATHON_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running hackhathon.
  echo.
